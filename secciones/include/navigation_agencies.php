                ...
                <ul class="navbar-nav ml-md-auto mt-2 mt-lg-0">
                    <li class="nav-item dropdown">
                        <a class="nav-flag dropdown-toggle nav-link" href="#" id="languageDropdown" data-toggle="dropdown" aria-expanded="false">
                            <img src="../assets/img/lang/us.png" alt="English" width="20" class="align-middle mr-1">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="languageDropdown">
                            ...
                            <a class="dropdown-item" href="#">
                                <img src="../assets/img/lang/es.png" alt="Spanish" width="20" class="align-middle mr-1">
                                <span class="align-middle">Spanish</span>
                            </a>
                        </div>
                    </li>
                    <li '.(($page=='account.php')?'class="current nav-item "':'class="nav-item "').'>
                    <a class="nav-link " href="account.php">'.$_SESSION['username'].' - '.$_SESSION['id_agency'].' </a>
                    </li>
                    <li class="nav-item">
